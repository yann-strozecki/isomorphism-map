...
int *occurences_array,*occ_addr_array;//structure used to compute the less frequent triple of vertex,edge,face in each graph
int different_vertex, maxindex, ini_addr;
