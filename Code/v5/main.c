...
int main (int argc, char *argv[])
{
  ...
  val_addr = malloc(mapsize*maxdegree*sizeof(int*));//a face is of size at most 
  maxindex = label.size*mapsize*maxdegree*different_vertex;
  occurences_array = calloc(maxindex,sizeof(int));//number of different label values
  occ_addr_array = malloc(maxindex*sizeof(int));
